    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4" style={{ background: "rgba(0, 0, 0, 0.15)" }}>
      <div
        ...
        style={{
          ...
          boxShadow: "0 20px 60px rgba(201, 96, 80, 0.2), 0 4px 16px rgba(0, 0, 0, 0.06)",
        }}
      >
        {/* Logo */}
        ...
        >
          Your AI assistant for Haberdashers&apos; Girls&apos; School
        </p>
        ...
        <div className="space-y-3 mb-6">
          <div className="flex items-start gap-3">
            <span
              ...
              style={{ background: "var(--school-accent)", color: "#ffffff" }}
            >
              1
            </span>
            <p className="text-sm" style={{ color: "var(--school-text-soft)" }}>
              <strong style={{ color: "var(--school-text)" }}>Ask a question</strong> — type
          ...
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm" style={{ color: "var(--school-text-soft)" }}>
              <strong style={{ color: "var(--school-text)" }}>Read the response</strong> — Beri
          ...
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm" style={{ color: "var(--school-text-soft)" }}>
              <strong style={{ color: "var(--school-text)" }}>Check the sources</strong> — expand
