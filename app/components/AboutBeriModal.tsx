        ...
        <dl className="space-y-5">
          <div>
            <dt
              ...
              style={{ color: "var(--school-accent-hover)", fontSize: "1.575rem" }}
            >
              What is Beri?
            </dt>
            <dd
            ...
            >
              ...
              Girls&apos; School using a custom based AI education framework,
          ...
          <div>
            ...
            <dd
              ...
              style={{ color: "var(--school-text-soft)" }}
            >
              Beri covers 11+ admissions, school fees and bursaries,
