...
const siteUrl = "https://beri-labs.github.io/AboutGirls_2";

// SEO: optimised title (50 chars) and meta description (155 chars)
export const metadata: Metadata = {
  title: "Beri | Haberdashers' Girls' School AI Assistant",
  description:
  ...
  openGraph: {
    title: "Beri | Haberdashers' Girls' School AI Chatbot",
    description:
  ...
  "@graph": [
    {
      ...
      description:
        "Beri is a student-built AI chatbot and school AI chatbot developed by BERI Labs as part of their education AI infrastructure. It uses retrieval-augmented generation (RAG) to answer questions about Haberdashers' Girls' School.",
      url: siteUrl,
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Beri can answer questions about Haberdashers' Girls' School, including 11+ admissions deadlines, school fees and bursaries, GCSE and A-level subject choices, sports and extracurricular activities, and general school life. Each answer includes cited sources.",
          },
        },
        {
          "@type": "Question",
